...
const meetingRoutes = require('./src/routes/meetings');  // Importing the meeting routes
const connectDB = require('./src/config/db');  // Importing the database connection method
